...
X, y, encoder, scaler = load_train_data('/Users/IkkiTanaka/Documents/kaggle/Otto/train_count_pca.csv')
X_test, ids = load_test_data('/Users/IkkiTanaka/Documents/kaggle/Otto/test_count_pca.csv', scaler)
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=55)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub1_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=60)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub2_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=80)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub3_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=60)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub4_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=80)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub5_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub6_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub7_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub8_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub9_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub10_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub11_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub12_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub13_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub14_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub15_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=40)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub16_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub17_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=65)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub18_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub19_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=65)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub20_all_count_pca.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub1_all_count_pca_lrelu.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub2_all_count_pca_lrelu.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub3_all_count_pca_lrelu.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=45)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub4_all_count_pca_lrelu.csv')
