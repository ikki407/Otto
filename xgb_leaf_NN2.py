...
param = {"objective" : "multi:softprob",
              ...
              "bst:subsample" :  0.65,#row_subsample
              "colsample_bytree" :  0.5,#column_subsample
              "silent": 1,
              "nthread" : 8}
num_round = 185
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=20)
net0.fit(new_X, y)
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN1.csv')
...
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN2.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=20)
net0.fit(new_X, y)
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN3.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=20)
net0.fit(new_X, y)
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN4.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=20)
net0.fit(new_X, y)
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN5.csv')


sub1 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN2.csv')
sub2 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN3.csv')
sub3 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN4.csv')
sub4 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN5.csv')
sub5 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN1.csv')
...
final_sub.to_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb2_NN2_4.csv',index = False)
