...
net0 = NeuralNet(layers=layers0,
                 ...
                 dropout0_p=0.5,
                 dense1_num_units=1048,
                 dropout1_p=0.5,
                 dense2_num_units=1048,
                 dropout2_p=0.5,
                 ...
                 max_epochs=80)
net0.fit(X, y)
make_submission(net0, X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub9_all.csv')
...
sub1 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb_sub.csv')
sub2 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb_sub1.csv')
sub3 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb_sub2.csv')
sub4 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb_sub5.csv')
sub5 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb_sub6.csv')
sub6 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb_sub7.csv')
sub7 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb_sub8.csv')
sub8 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb_sub9.csv')
sub9 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub1_all.csv')
sub10 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub2_all.csv')
sub11 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub3_all.csv')
sub12 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub4_all.csv')
sub13 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/neural_net_sub5_all.csv')
sub14 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb1.csv')

#submission1と2を使ってみる. 3は化学臭すぎ?


final_sub = (sub1+sub4+sub5+sub6+sub7+sub8+sub9+sub10+sub11+sub12+sub13+sub14)/12.0
final_sub['id'] = final_sub['id'].astype(int)
final_sub.to_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/sd_xgbsub0_5_9_neural_all_1__5_xgb1.csv',index = False)
