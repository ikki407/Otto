...
if not (index_tr[0] == index_te[0]).all():
...
new_X = np.c_[X,pred_leaf_tr[:,:200]]
new_X_test = np.c_[X_test,pred_leaf_te[:,:200]]
#randomIndex = [i for i in xrange(len(trainlabel))]
#random.shuffle(randomIndex)
print y
...
for i in xrange(0,50):
    layers0 = [('input', InputLayer),
            ('dropout_in', DropoutLayer),
               ...
               ('output', DenseLayer)]
    dense_list = [random.randint(900, 1400),random.randint(600, 1000),random.randint(300, 650),random.randint(200, 550)]
    leakness_list = [random.uniform(.0001, .0005),random.uniform(.0001, .0005),random.uniform(.0001, .0005),random.uniform(.0001, .0005)]
    max_iter = random.randint(110,180)
    ...
    if min(val_loss) < 0.48:
        ...
        submission_name = '/Users/IkkiTanaka/Documents/kaggle/Otto/xgblrelu3ada%i_%f_d%i_%i_%i_l%f_%f_%f_dr%f_m%i.csv' % (i,min_loss,dense_list[0],dense_list[1],dense_list[2],leakness_list[0],leakness_list[1],leakness_list[2],dropout_in,max_iter2)
        make_submission(net0, new_X_test, ids, encoder, name=submission_name)
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=20)
net0.fit(new_X, y)
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN1.csv')
...
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN2.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=20)
net0.fit(new_X, y)
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN3.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=20)
net0.fit(new_X, y)
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN4.csv')
...
net0 = NeuralNet(layers=layers0,
                 ...
                 max_epochs=20)
net0.fit(new_X, y)
make_submission(net0, new_X_test, ids, encoder, name='/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN5.csv')


sub1 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN2.csv')
sub2 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN3.csv')
sub3 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN4.csv')
sub4 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN5.csv')
sub5 = pd.read_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN1.csv')

#submission1と2を使ってみる. 3は化学臭すぎ?


final_sub = (sub1+sub2+sub3+sub4+sub5)/5.0
final_sub['id'] = final_sub['id'].astype(int)
final_sub.to_csv('/Users/IkkiTanaka/Documents/kaggle/Otto/xgb3_NN2_4.csv',index = False)
